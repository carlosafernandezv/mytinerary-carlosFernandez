...
function SingUp() {
  ...
  <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style={{'backgroundImage':'url(https'}}>
  ...
  <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style={{'backgroundColor':'#161616'}}>
    <div className="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center" style={{'backgroundImage':'url(https'}}>
      <div className="absolute bg-black opacity-60 inset-0 z-0" />
    </div>
